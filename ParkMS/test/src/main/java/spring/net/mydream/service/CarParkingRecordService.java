...
public class CarParkingRecordService{
	...
	public List<CarParkingRecord> listCR(Integer orgId,Integer parkManageId) throws PreconditionException{
	...
	public CarManage getByPlateNumberCR(String plate_number,Integer park_manage_id) throws PreconditionException{
