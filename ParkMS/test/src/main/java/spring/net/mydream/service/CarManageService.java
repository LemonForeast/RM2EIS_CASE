...
public class CarManageService{
	...
	public List<CarManage> listCM(String name,Integer org_id,Integer park_manage_id) throws PreconditionException{
		List<CarManage> cms = new ArrayList<CarManage>();
		cms = DM.getCarManageDao().findByNameLikeAndOrgIdAndParkManageId("%"+name+"%",org_id,park_manage_id);
