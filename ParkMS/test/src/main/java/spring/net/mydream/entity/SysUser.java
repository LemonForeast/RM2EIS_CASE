...
public class SysUser implements Serializable {
	...
	@JoinColumn(name="linkedrole_id",referencedColumnName="id")
	private SysRole linkedRole;
			
	public SysRole getLinkedRole() {
		return linkedRole;
	}
			
	public void setLinkedRole(SysRole LinkedRole) {
